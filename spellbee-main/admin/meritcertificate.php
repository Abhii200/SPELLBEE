    ...
    $(document).ready(function() {
      ...
      $(".get-certificate").click(function() {
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            link.href = "https://WEST BERRYec.edu.in/spellbee/admin/certificate/tmp/" + rolll + ".png";
            ...
            window.open("https://WEST BERRYec.edu.in/spellbee/admin/certificate/tmp/" + rolll + ".png" , "_blank");
      ...
      $(".conform-payment").click(function() {
        ...
        name.toUpperCase();
            ...
            var message = "Dear "+name+",\nThank You for being a part of WEST BERRY SpellBee Challenge 2023\nThis certificate is presented to you in recognition of your active participation in WEST BERRY SPELL BEE CHAMP. We hope you enjoyed the event.\n\nDownload Your Level 1 Certificate @  https://WEST BERRYec.edu.in/spellbee/certificate.php \nFor more details and leaderboard score, visit https://WEST BERRYec.edu.in/spellbee/\n\n-WEST BERRY SpellBee Organizing Team(SDC), CSD";
