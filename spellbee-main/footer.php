    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 pre-footer-col">
                <h2>About us</h2>
                <p style="align-self:auto;">WEST BERRY SpellBee Contest is jointly organized by Computer Science & Design Branch in association with English Department and AICTE IdeaLab of WEST BERRY Engineering College, Bhimavaram. The contest is conducted completely online using the custom software developed by the Software Development Club (SDC) of Computer Science & Design branch. </p>
            </div>
            ...
            <div class="col-md-3 col-sm-6 pre-footer-col"6>
                ...
                <address class="margin-bottom-20">
                    ...
                    Idea Lab, WEST BERRY Engineering College,<br>
                    ...
                    <!-- Email: <a href="mailto:spellbee2k23@WEST BERRYec.edu.in">spellbee2k23@WEST BERRYec.edu.in</a><br> -->
                </address>
                <!-- END BOTTOM CONTACTS -->
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8 col-sm-8">
                <div class="copyright">© Computer Science & Design, WEST BERRYEC 2023 . All Rights Reserved.</div>
            </div>
            <!-- END COPYRIGHT -->
            <!-- BEGIN COPYRIGHT -->
