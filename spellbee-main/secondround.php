...
<body class="menu-always-on-top">
    ...
    <div class="team-block content content-center margin-bottom-40" id="team">
        <div class="container">
            <h2>WEST BERRY SPELLBEE <strong>SECOND ROUND SELECTED</strong></h2>
            <h4>These are the students selected for Second Round of<strong>WEST BERRY SPELLBEE</strong> .<br></h4>
