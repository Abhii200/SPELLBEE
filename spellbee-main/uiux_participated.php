...
<body class="menu-always-on-top">
            ...
            <div class="row">
                ...
                <div class="col-md-10 pull-right">
                    <ul class="header-navigation">
                        <li><a href="index.php"><strong style='color:#C91E3E;'>WEST BERRY CampusOnline</strong></a></li>
                    </ul>
                </div>
                <!-- Navigation END -->
            </div>
    ...
    <div class="team-block content content-center margin-bottom-40" id="team">
        <div class="container">
            <h2>WEST BERRY CampusOnline <strong>UI/UX workshop - Purplelane</strong></h2>
