...
<head>
    <meta charset="utf-8">
    <title>Leaderboard WEST BERRY SPELLBEE</title>
...
<body class="menu-always-on-top">
    ...
    <div class="services-block content content-center" id="services">
        <h2><strong><b>WEST BERRY SPELLBEE PRIZES</b></strong></h2>
        <div class="container">
            <div class="ab-trio">
    ...
    <div class="team-block content content-center margin-bottom-40" id="team">
        <div class="container">
            ...
            <h4>The Leader Board has been generated for all participants who played <strong>WEST BERRY SPELLBEE</strong> .<br>
