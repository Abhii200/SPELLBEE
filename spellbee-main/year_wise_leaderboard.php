...
<head>
    <meta charset="utf-8">
    <title><?php echo  $years . " / 4 " ?> - WEST BERRY SPELLBEE Leaderboard</title>
...
<body class="menu-always-on-top">
    ...
    <div class="about-block content content-center" id="about">
        <div class="container">
            <br>
            <h2><strong><b><?php echo $years . " / 4 "  ?> WEST BERRY SPELLBEE LEADERBOARD</b></strong>
                <br>WEST BERRY ENGINEERING COLLEGE
            </h2>
        </div>
    </div>
    <!-- About block END -->
    ...
    <div class="team-block content content-center margin-bottom-40" id="team">
        <div class="container">
            <h2>WEST BERRY SPELLBEE <strong>Leaderboard</strong></h2>
            ...
            <!--			<strong>NOTE:</strong> This Leader Board is not the list of students selected for Level 2 or 3. It is meant only for preparing the Top 100 Coders List of WEST BERRYEC.</h4> -->
