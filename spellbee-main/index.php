...
<head>
    <meta charset="utf-8">
    <title>WEST BERRY Spell Bee - Online Spelling Challenge </title>
...
<body class="menu-always-on-top">
        ...
        <div id="carousel-example-generic" class="carousel slide carousel-slider" style="margin-top: 60px;">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="item carousel-item-one active">
                    <img class="carousel-position-WEST BERRYec animate-delay" data-animation="animated fadeInDown">
    ...
    <div class="about-block content content-center" id="about">
        <div class="container">
            <h2><strong><b>SpellBee Champ of WEST BERRY</b></strong></h2>
            <h2>The Ultimate Online SpellBee Challenge of The Campus</h2>
            <h4>WEST BERRY SpellBee is an unique online spelling check challenge conducted to test the Spelling skills of
                WEST BERRYEC students. Only WEST BERRYEC students (all branches & years of B.E/B.Tech programmes) are eligible to
            ...
            <a name='rules'></a>
            <div class="container">
                <h2 class="margin-bottom-20" style='font-size:24px;'><strong>Levels</strong> Of WEST BERRY SpellBee Challenge
                </h2>
                <div class="row">
                    <!-- Pricing item BEGIN -->
        ...
        <div class="container">
            ...
            <a href="ranks.php" target="_blank" class="btn blink"
                style='background-color:#C91E3E;color:#ffff; font-size:18px;box-shadow: 3px 3px 1px white;'><b> VIEW
                    WEST BERRY SPELLBEE LEADERBOARD</b></a><br><br><br>
                    ...
                    <div class="panel-group" id="accordion1">
                        <div class="panel panel-default">
                            ...
                            <div id="accordion1_1" class="panel-collapse collapse in">
                                <div class="panel-body">
                                    <p>The Spell Bee contest is only for the students of WEST BERRY Engineering College.
                            ...
                            <div id="accordion1_3" class="panel-collapse collapse">
                                <div class="panel-body">
                                    <p>SpellBee Challenge is a popular contest all across the globe and
                                        ...
                                        peers
                                        of WEST BERRY. WEST BERRY SpellBee Challenge 2023 is going to generate Ranks for the top
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="accordion1_6" class="panel-collapse collapse">
                                <div class="panel-body">
                                    <p>Contact Technology Centre, I-Hub, Z-Block, WEST BERRY Engineering College, Bhimavaram
    ...
    <div class="facts-block content content-center" id="facts-block">
        <a href="ranks.php" target="_blank" class="btn blink"
            style='background-color:#C91E3E;color:#ffff; font-size:18px;box-shadow: 3px 3px 1px white;'><b> View WEST BERRY
    ...
    <div class="team-block content content-center margin-bottom-40" id="team">
        <div class="container">
            ...
            <h4>The contest - Spell Bee Champ of WEST BERRY is organized in assocation with Engilish Department, IDEALab and
                Technology Centre</h4>
            <div class="row">
                <div class="col-md-2 item">
                    <h3 style="font-size:14px;">Dr.N.G.K.Murthy</h3>
                    <em style="font-size: 10px;">Head, Technology center, WEST BERRYEC</em>
                </div>
                <div class="col-md-2 item">
                    <h3 style="font-size:14px;">Bh.V.N.Lakshmi</h3>
                    <em style="font-size: 10px;">Professor, Dept. of English, WEST BERRYEC</em>
                </div>
                <div class="col-md-2 item">
                    <h3 style="font-size:14px;">Dr. Suresh Mudunuri</h3>
                    <em style="font-size: 10px;">Programme Co-ordinator, CSD, WEST BERRYEC</em>
                </div>
                <div class="col-md-2 item">
                    <h3 style="font-size:14px;">M Sankar</h3>
                    <em style="font-size: 10px;">Asst.Professor, Dept. of English, WEST BERRYEC</em>
                </div>
                <div class="col-md-2 item">
            ...
            <div class="row">
                ...
                <div class="col-md-2 item">
                    ...
                    <em style="font-size: 10px;">Associate Professor, Dept. of English, WEST BERRYEC</em>
                </div>
                <div class="col-md-2 item">
            ...
            <div class="row">
                ...
                <div class="col-md-2 item">
                    ...
                    <em style="font-size: 10px;">Asst.Professor, CSD, WEST BERRYEC</em>
                </div>
                <div class="col-md-2 item">
